...
class Quadrature:
    ...
    def simpson(func, x0, x1, rtol = 1.0e-10, nseg0 = 1):
        ...
        print("Total function calls: " + str(Quadrature.__ncalls))
        return ans
b=' 4.74499410004808*psix11**2*sin(0.581775925925926*y)**2*sin(0.581775925925926*x)**2 '

c=Quadrature.simpson(lambda x:  4.74499410004808*sin(0.581775925925926*x)**2 , 0, 1.5, rtol=1e-9)
print(c)